...
module Goliath
  module Rack
    ...
    module Templates
      ...
      # @param [Symbol, String] template Template Path (symbol) or contents (String)
      # @param [Hash] options Rendering options -- see {#render}
      # @param [Hash] locals  Template-local variables -- see {#render}
      # @see #render
      ...
      #
      # @param [Symbol] engine The engine (:haml, :erb, :textile, etc) to use
      ...
      #
      # @param [Hash] options Options for layout
      # @option options [String] :content_type   The MIME content type to use.
      ...
      # @option options [Object] :scope          If set, template is evaluate with the binding of the given object rather than the application instance.
